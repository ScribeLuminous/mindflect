# --- stress_q5.py (FIXED for Live Validation, 1-10 Integer) ---
...
class stress_q5(stress_q5Template):
  def __init__(self, **properties):
    ...
    self.q5_next_btn.enabled = False  # Disable the Next button initially
  ...
  def live_validate(self):
    ...
    if valid:
      ...
      if 1 <= int(result) <= 10:
        self.label_error.visible = False
        self.q5_next_btn.enabled = True # Enable the button
        return True
